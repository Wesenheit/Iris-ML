...
if __name__ == "__main__":
    ...
    check_apogee(args.number,iner = True,para = args.para, name_server = name_server, batch = args.batch,num_p=args.num_p)
    check_apogee(args.number,iner = False,para = args.para, name_server = name_server, batch = args.batch,num_p=args.num_p)